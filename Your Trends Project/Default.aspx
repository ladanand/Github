<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="bootstrap10_Default" %>
...
<style>
#draggable-zone {
	background: #000 url(images/01.jpg) 0 0 no-repeat;
...
<body id="home" class="homepage">
    ...
    <header id="header">
        ...
        <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" Text="Hide" CssClass="btn btn-warning" />
            ...
            <a href="buytu.aspx">     <input name="b_print" type="button" class="btn btn-warning"   onclick="printdiv('p')" value=" buy "/></a> 
