<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Defaults.aspx.cs" Inherits="bootstrap10_Default" %>
...
<style>
#draggable-zone {
	background: #000 url(images/04.jpg) 0 0 no-repeat;
...
<body id="home" class="homepage">
    ...
    <header id="header">
        ...
        <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" Text="Hide" CssClass="btn btn-warning" />
            ...
            <a href="buysw.aspx">     <input name="b_print" type="button" class="btn btn-warning"   onclick="printdiv('p')" value=" buy "/></a> 
