<%@ Page Language="C#" AutoEventWireup="true" CodeFile="buysw.aspx.cs" Inherits="bootstrap10_Default2" %>
                  ...
                  <asp:TextBox ID="addr" runat="server" class="form-control" Rows="8" placeholder="address" required TextMode="MultiLine"></asp:TextBox>
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <asp:TextBox ID="qty" runat="server" class="form-control" placeholder="Quantity" required AutoPostBack="true" OnTextChanged="qty_TextChanged"></asp:TextBox>

                                 </div>


                            <div class="form-group">
                                <asp:FileUpload ID="FileUpload1" class="btn btn-danger" runat="server" />  <br /><asp:Label ID="Label1" runat="server" Text="Label"></asp:Label>
                                </div>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
