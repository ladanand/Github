v<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminorder.aspx.cs" Inherits="preview_dotnet_templates_with_out_masterpages_Shop_item_index" %>
                ...
                <div class="thumbnail">
                    ...
                    <div class="intro-note topspace10">
                        <div class="col-md-12 text-center">
                            ...
                            <h1>Orders</h1>
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Order_id" DataSourceID="SqlDataSource1" CellPadding="4" ForeColor="#333333" GridLines="None" Width="876px" AllowPaging="True" >
                                <AlternatingRowStyle BackColor="White" />
                                <Columns>
                                    <asp:BoundField DataField="Order_id" HeaderText="Order_id" ItemStyle-Width="  110px" ReadOnly="True" SortExpression="Order_id" InsertVisible="False"  />
                                    <asp:BoundField DataField="Vendor_id" HeaderText="Vendor_id" SortExpression="Vendor_id" ItemStyle-Width="120px" />
                                    <asp:BoundField DataField="Dispatch" HeaderText="Dispatch" SortExpression="Dispatch" ItemStyle-Width="150px" />
                                    <asp:BoundField DataField="Bill" HeaderText="Bill" SortExpression="Bill" ItemStyle-Width="120px" />
                                    <asp:BoundField DataField="City" HeaderText="City" SortExpression="City" ItemStyle-Width="80px" />
                                    <asp:BoundField DataField="Quantity" HeaderText="Quantity" SortExpression="Quantity" />
                                    <asp:BoundField DataField="Color" HeaderText="Color" SortExpression="Color" ItemStyle-Width="80px"/>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server"  SelectCommand="SELECT [Order_id], [Vendor_id], [Dispatch], [Bill], [City], [Quantity], [Color], [Type], [Size] FROM [Order1]" ConnectionString="Data Source=(LocalDB)\v11.0;AttachDbFilename=|DataDirectory|\Database3.mdf;Integrated Security=True" ProviderName="System.Data.SqlClient"></asp:SqlDataSource>
