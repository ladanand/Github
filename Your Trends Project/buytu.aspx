<%@ Page Language="C#" AutoEventWireup="true" CodeFile="buytu.aspx.cs" Inherits="bootstrap10_Default2" %>
                  ...
                  <asp:TextBox ID="addr" runat="server" class="form-control" Rows="8" placeholder="address" required TextMode="MultiLine"></asp:TextBox>
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <asp:TextBox ID="qty" runat="server" class="form-control" placeholder="Quantity" AutoPostBack="true" OnTextChanged="qty_TextChanged" required></asp:TextBox>

                                 </div>

                            <div class="form-group">
                                <asp:FileUpload ID="FileUpload1" class="btn btn-danger" runat="server" />  <br />
